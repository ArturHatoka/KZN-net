<?php
//717 kznnet
define(MySQLprefix, "viz717");
$m_Link = mysql_connect("p376856.mysql.ihc.ru", "p376856_kznnet", "gh5dtnbr") or die ("<!-- Ошибка подключения к серверу. -->");
mysql_query("SET NAMES utf8");
mysql_select_db("p376856_kznnet") or die ("<!-- Ошибка соединения с БД. -->");
